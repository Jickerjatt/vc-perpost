...
function initializePlugin(api) {
 ...
 api.attachWidgetAction('post-menu', 'showVotecount', function() {
    ...
    Votecount.getVotecount(this.attrs.topicId, post_number).then(function(vcJson) {
      ...
      var vc_arr  = getVotecountArr(vcJson.votecount, vcJson.alive);
...
// todo: include this into getvotecounthtml or call from there
...
// todo: this should also take json input
